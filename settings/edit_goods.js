...
{ 
	...
	if (byId('samedetails').checked ==true)
	{
		...
		var combo1 = byId('cmbstate').value;
        var combo2 = byId('cmblgov').value;
		var value1 = byId('txtPermadd').value.trim();
		//alert(value1);
		if(value1!=""){
			//load in to guardian boxes
			byId('cmbcstate').value = combo1;
			emptyCombo(byId('cmbclgov'));
			addOption(byId('cmbclgov'), combo2, combo2);
			byId('txtcPermadd').value = value1;
		}	
		
	}
	else
	{
		byId('txtcPermadd').value = "";
		emptyCombo(byId('cmbclgov'));
		addOption(byId('cmbclgov'), "Select Local Government", "Select Local Government");
		byId('cmbcstate').value = "Select State";
		byId('cmbclgov').value = "Select Local Government";
	}	
}
...
//state changes
	...
	function stateCombo()
    {
        var combo1 = byId('cmbcstate');
        var combo2 = byId('cmbclgov');
		//alert("we");
        emptyCombo(combo2);
        switch(combo1.value)
        {
