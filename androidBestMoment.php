...
{		
	...
	$txtcPermadd=$row['userBestMoment'];
	if($txtcPermadd ==""){
		$txtcPermadd="";
	}
}
	...
	if($txtcPermadd=="" )
		{
			...
			$stmt_in = $conn->prepare("UPDATE userDetails SET userBestMoment=? where userRegNo=? And userID=? Limit 1");
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin-top:15px;margin-bottom:15px;">
			<form role="form"  name="reg_form"  id="form" class="form-vertical" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" method="POST">
				<div class="form-group">
					<label for="txtcPermadd">Describe Your Best Moment In Atbu : </label>
					<div class="input-group">
						<span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
						<textarea class="form-control"  rows="20" id="txtcPermadd" name="txtcPermadd" required="true" placeholder="Enter Your Best Moment In Atbu">
